...
def parse_args():
    ...
    parser.add_argument("--epochs", "-e", help="total epoch", type=int, default=2)
    parser.add_argument("--step", "-s", help="print step", type=int, default=5)
...
def train():
    ...
    # train_data = StockDataset('dataset/machine-2-1_test.pkl', 5, is_test=False)
